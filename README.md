...
10. [`opencloud`](opencloud) - docker compose setup for [OpenCloud](https://opencloud.eu), a self-hosted file sync, share and collaboration platform with on-prem [Euro Office](https://github.com/EURO-office/DocumentServer) document editing.
