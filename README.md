...
3. [`beszel`](./beszel/) - ocker compose setup for a [Beszel](https://beszel.dev/) system monitoring server that can monitor both system usage, services and docker containers.
4. [`firefly-iii`](firefly) - docker compose setup for [Firefly III](https://github.com/firefly-iii/firefly-iii) and [Firefly III Data Importer](https://github.com/firefly-iii/data-importer) installation for money management and reporting
